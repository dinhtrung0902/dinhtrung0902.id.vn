<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phan_khoi) && 
            ...
            $sql="UPDATE sanpham SET ten_sp='$ten_sp',gia_sp='$gia_sp',bao_hanh='$bao_hanh',khuyen_mai='$khuyen_mai',"
                    . "phan_khoi='$phan_khoi',tinh_trang='$tinh_trang',trang_thai='$trang_thai',"
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phan_khoi" value="<?php if(isset($_POST['phan_khoi'])){echo $_POST['phan_khoi'];}else{echo $row['phan_khoi'];} ?>" required="">
                        </div>
                        <div class="form-group">
