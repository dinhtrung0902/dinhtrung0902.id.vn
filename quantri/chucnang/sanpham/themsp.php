<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if (isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && isset($tinh_trang) && isset($khuyen_mai) && isset($trang_thai) && isset($chi_tiet_sp) && isset($anh_sp) && isset($id_dm) && isset($dac_biet)) {
            ...
            $sql="INSERT INTO sanpham(ten_sp,gia_sp,bao_hanh,phan_khoi,tinh_trang,khuyen_mai,trang_thai,chi_tiet_sp,anh_sp,id_dm,dac_biet) VALUES('$ten_sp','$gia_sp','$bao_hanh','$phan_khoi','$tinh_trang','$khuyen_mai','$trang_thai','$chi_tiet_sp','$anh_sp','$id_dm','$dac_biet')";
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bao_hanh"  required="">
                        </div>

                        <div class="form-group">
                            <label>Phân khối</label>
                            <input type="text" class="form-control" name="phan_khoi"  required="">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_dm" class="form-control">
                                <option value="unselect" selected>Lựa chọn hãng xe</option>
                                <?php
