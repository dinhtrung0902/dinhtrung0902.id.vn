<?php  
    ...
    if ($_SESSION['email']=='admin@gmail.com' && $_SESSION['pass']=='123' || $_SESSION['email']=='trung@gmail.com' && $_SESSION['pass']=='220120') {
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>Huyền thoại xe máy</title>
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="quantri.php"><span>HUYỀN THOẠI XE MÁY </span>| Admin</a>
                    <ul class="user-menu">
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                <li class="parent"><a href="quantri.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Trang chủ quản trị</a></li>
                <li class="parent ">
                ...
                <li class="parent ">
                    ...
                    <ul class="children collapse" id="sub-item-3">
                        <li>
                            <a class="" href="quantri.php?page_layout=themdonhang">
                                <svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Thêm mới
                            </a>
                        </li>
                ...
                if(isset($_GET['page_layout'])){
                    switch ($_GET['page_layout']) {
                        ...
                        case 'suaquangcao': include_once'./chucnang/quangcao/suaquangcao.php';
                            break;
                        case 'danhsachdonhang': include_once'./chucnang/donhang/danhsachdonhang.php';
                            break;
                        case 'themdonhang': include_once'./chucnang/donhang/themdonhang.php';
                            break;
                        case 'suadonhang': include_once'./chucnang/donhang/suadonhang.php';
                            break;
...
?>
<script>
    // Lắng nghe sự kiện nhấp chuột vào nút menu
    document.addEventListener('DOMContentLoaded', function () {
        ...
        menuItems.forEach(function (menuItem) {
            menuItem.addEventListener('click', function () {
                // Kiểm tra xem có lớp "active" đã tồn tại hay không
                if (currentActive) {
                    currentActive.parentElement.classList.remove('active');
                }
                
                // Thêm lớp "active" cho nút menu được nhấp vào
                this.parentElement.classList.add('active');
                
                // Cập nhật nút menu hiện tại
                currentActive = this;
            });
        });
    });
